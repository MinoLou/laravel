...
class usuariosController extends Controller
{
	...
	public function leerbase(Request $request){
		...
		$datos_usuario = array("name" => $base[$id_usuario]['name'], "surname" => $base[$id_usuario]['surname'], "dni" => $base[$id_usuario]['dni'], "birthdate" => $base[$id_usuario]['birthdate'], "email" => $base[$id_usuario]['email'], "ext" => $base[$id_usuario]['ext']);
		session_start();
